...
public class MediaDatabase {
    ...
    public static void setPicture(Context ctx, MediaWrapper m, Bitmap p) {
        Log.d(TAG, "Setting new picture for " + m.getTitle());
        try {
            getInstance(ctx).updateMedia(
                    m.getUri(),
     ...
     *
     * @param uri of the item (primary key)
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public SQLiteDatabase getWritableDatabase() {
            ...
            try {
                ...
                try {
                    db = SQLiteDatabase.openOrCreateDatabase(mContext.getApplicationContext().getDatabasePath(DB_NAME), null);
