...
import com.infomedia.vlcplayer.R;
...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions(Context context) {
        ...
        final boolean timeStrechingDefault = context.getApplicationContext().getResources().getBoolean(R.bool.time_stretching_default);
